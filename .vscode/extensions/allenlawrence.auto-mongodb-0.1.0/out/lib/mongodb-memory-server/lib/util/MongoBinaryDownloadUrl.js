...
var MongoBinaryDownloadUrl = function () {
    function MongoBinaryDownloadUrl(_ref) {
        var platform = _ref.platform, arch = _ref.arch, version = _ref.version, os = _ref.os;
    ...
    _createClass(MongoBinaryDownloadUrl, [{
            ...
            value: function getSuseVersionString(os) {
                var _ref8 = os.release.match(/(^11|^12)/) || [null], _ref9 = _slicedToArray(_ref8, 1), release = _ref9[0];
                if (release) {
                    return `suse${release}`;
                }
                return '';
